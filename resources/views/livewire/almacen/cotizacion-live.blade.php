            ...
            <div class="mb-4 lg:mb-0">
                <div class="grid grid-flow-col auto-cols-max space-x-1">
                    <div wire:ignore class="pt-4 pb-4 w-64">
                        <label class="block text-sm font-medium text-gray-900 dark:text-white" for="product_id">Producto</label>
                    ...
                    <div>
                        <x-text-input wire:model.live='cantitad_detalle' class="w-16 p-1" type='number' for='' label='Cantidad' placeholder="Cantidad">
                        </x-text-input>
                    </div>
                    <div>
                        <x-text-input wire:model.live='price_cotizacion' class="w-16" type='number' for='' label='Precio Unitario' placeholder="Precio">
                        </x-text-input>
                    </div>
                    <div class="pt-5">
