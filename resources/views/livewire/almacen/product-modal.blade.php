            ...
            <div class="w-full bg-white dark:bg-gray-800">
                ...
                <div x-show="openTab === 1"
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            <x-text-input wire:model.live='productForm.porcentaje' type='number' min="0" step="0.1"
                                for='porcentaje' label='Porcentaje' placeholder='Ingrese porcentaje' required />
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            <x-text-input wire:model.live='productForm.dias_entrega' type='number' min="0" step="1"
                                for='dias_entrega' label='Porcentaje' placeholder='Ingrese dias entrega' required />
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            <x-text-input wire:model.live='productForm.garantia' type='number' min="0" step="1"
                                for='garantia' label='Meses de garantia' placeholder='Ingrese garantia' required />
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            <x-area-input wire:model.live='productForm.description' type='text'
                                for='description' label='Description' placeholder='Ingrese description' required />
