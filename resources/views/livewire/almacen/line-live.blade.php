            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input wire:model.live='search' type="text" data-kt-line-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-13" placeholder="Search line" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            <!--begin::Toolbar-->
                            <div class="d-flex justify-content-end" data-kt-line-table-toolbar="base">
                                <!--begin::Export-->
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-350px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bold">Export Lines</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-5 my-1">
                                                <!--begin::Form-->
                                                <form class="form" wire:submit="exportLine">
                                                    <!--begin::Input group-->
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-350px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-5 my-0">
                                                <!--begin::Form-->
                                                <form class="form"
                                                    wire:submit="{{ isset($lineForm->line) ? 'updateLine' : 'createLine' }}">
                                                    <!--begin::Scroll-->
                                                    <div class="d-flex flex-column scroll-y-auto px-0 px-lg-5">
                                                        ...
                                                        <div class="row mb-7">
                                                            <div class="col-12">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input wire:model.live='lineForm.code' type="text"
                                                        ...
                                                        <div class="row mb-7">
                                                            <div class="col-12">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" wire:model.live='lineForm.name'
                                                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                                                    placeholder="name" />
                                                                @error('lineForm.name')
                                                                    <span class="error">{{ $message }}</span>
                    ...
                    <div class="card-body border-0 pt-6">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_lines">
                            <thead>
                                    ...
                                    <tr wire:key='line{{ $line->id }}'>
                                        ...
                                        <td>
                                            <button wire:click='estado({{ $line->id }})'
                                                ...
                                                <div
                                                    class="badge badge-light-{{ $line->isActive ? 'success' : 'danger' }} fw-bold">
                                                    {{ $line->isActive ? 'Enabled' : 'Disabled' }}
                                                </div>
                                            </button>
                                        </td>

                                        <td class="text-end">
                                            <button wire:click='update({{ $line->id }})'
