        ...
        <div class="w-full mb-1">
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    ...
                    @if ($isOpenModal)
                        <x-modal title="{{ isset($categoryForm->category) ? 'Update Category' : 'Create Category' }}" maxWidth='sm'>
                            <form class="form"
                                wire:submit="{{ isset($categoryForm->category) ? 'updateCategory' : 'createCategory' }}">
                                <div class="p-4 md:p-5 space-y-4">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-6">
                                            <x-text-input wire:model.live='categoryForm.code' type='text' for='code'
                                        ...
                                        <div class="col-span-6 sm:col-span-6">
                                            <x-text-input wire:model.live='categoryForm.name' type='text' for='name'
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        @forelse ($this->categories as $category)
                            <tr wire:key='category-{{ $category->id }}' class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <x-edit-button wire:click='update({{ $category->id }})'>
                                    </x-edit-button>
                                    <x-delete-button wire:click='delete({{ $category->id }})'
