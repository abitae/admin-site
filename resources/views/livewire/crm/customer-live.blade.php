        ...
        <div class="w-full mb-1">
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    ...
                    @if ($isOpenModal)
                        <x-modal title="{{ isset($customerForm->customer) ? 'Update customer' : 'Create customer' }}"
                            maxWidth='2xl'>
                            <form class="form"
                                wire:submit="{{ isset($customerForm->customer) ? 'updateCustomer' : 'createCustomer' }}">
                                <div class="p-4 md:p-5 space-y-4">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-2">
                                            <x-select-input wire:model.live="customerForm.type_code" for='rol'
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            <x-text-input wire:model.live='customerForm.code' type='text'
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-3">
                                            <x-text-input wire:model.live='customerForm.first_name' type='text'
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <x-text-input wire:model.live='customerForm.last_name' type='text'
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-2">
                                            ...
                                            <input wire:model.live='customerForm.date_brinday' type="date"
                                                type="text"
                                        ...
                                        <div class="col-span-6 sm:col-span-2">
                                            <x-text-input wire:model.live='customerForm.phone' type='text'
                                        ...
                                        <div class="col-span-6 sm:col-span-2">
                                            <x-text-input wire:model.live='customerForm.email' type='email'
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-6">
                                            ...
                                            <x-text-input wire:model.live='customerForm.address' type='text'
