        ...
        <div class="w-full mb-1">
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    ...
                    @if ($isOpenModal)
                        <x-modal title="{{ isset($negocioForm->negocio) ? 'Update negocio' : 'Create negocio' }}"
                            maxWidth='2xl'>
                            <form class="form"
                                wire:submit="{{ isset($negocioForm->negocio) ? 'updateNegocio' : 'createNegocio' }}">
                                <div class="p-4 md:p-5 space-y-4">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-2">
                                            <x-select-input wire:model.live="negocioForm.type_code" for='rol'
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            <x-text-input wire:model.live='negocioForm.code' type='text'
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-3">
                                            <x-text-input wire:model.live='negocioForm.first_name' type='text'
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <x-text-input wire:model.live='negocioForm.last_name' type='text'
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-2">
                                            ...
                                            <input wire:model.live='negocioForm.date_brinday' type="date"
                                                type="text"
                                        ...
                                        <div class="col-span-6 sm:col-span-2">
                                            <x-text-input wire:model.live='negocioForm.phone' type='text'
                                        ...
                                        <div class="col-span-6 sm:col-span-2">
                                            <x-text-input wire:model.live='negocioForm.email' type='email'
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-6">
                                            ...
                                            <x-text-input wire:model.live='negocioForm.address' type='text'
