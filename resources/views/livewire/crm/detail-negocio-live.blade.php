<div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
    ...
    <div class="col-span-2">createNegocioupdateNegocio
        <div
            class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            <h3 class="mb-4 text-xl font-semibold dark:text-white">Oportunidad de Negocio</h3>
            <form class="form"wire:submit='{{ $negocioForm->negocio ? "createNegocio" : "updateNegocio" }}'>
                    ...
                    <div wire:ignore class="col-span-3 sm:col-span-3">
                        ...
                        <select wire:model.live="negocioForm.customer_id" id="customer_id"
                            ...
                            @forelse ($customers as $customer)
                                <option value="{{ $customer->id }}">{{ $customer->id }} {{ $customer->first_name }}
