            ...
            <div class="p-4 space-y-4 md:p-5">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <x-text-input wire:model.live='customerForm.code' type='text' for='code'
                            label='Numero documento' placeholder='Ingrese numero documento' required />
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-6">
                        <x-text-input wire:model.live='customerForm.first_name' type='text' for='first_name'
                            label='Nombres' placeholder='Ingrese nombres' required />
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-2">
                        ...
                        <input wire:model.live='customerForm.date_brinday' type="date" type="text"
                    ...
                    <div class="col-span-6 sm:col-span-2">
                        <x-text-input wire:model.live='customerForm.phone' type='text' for='phone'
                            label='Telefono' placeholder='Ingrese telefono' required />
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <x-text-input wire:model.live='customerForm.address' type='text' for='address'
                            label='Direccion' placeholder='Ingrese address' required />
